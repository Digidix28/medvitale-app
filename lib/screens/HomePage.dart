...
import 'package:doctor_app/screens/DetailsPage.dart';
                            ...
                            child: (rdv.length == 0)
                                ? Center(
                                    child: Column(
                                      ...
                                      children: [
                                        Image(
                                          image: AssetImage(
                                              "assets/images/mirage-list-is-empty.png"),
                                          height: 200,
                                        ),
                                        Text(
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      final subTitle =
                                          rdv[index].get('adresse');
                                      final taux = rdv[index].get('taux');
                                      final nom = rdv[index].get('nom');
                                      final prenom = rdv[index].get('prenom');
                                      final Timestamp t = rdv[index].get('date');
                                      final date = t.toDate().toString().substring(0,10);
                                      return Container(
